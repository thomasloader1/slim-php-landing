            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div class="flex gap-3 items-center">
                        <div class="w-10 h-10 rounded-xl bg-slate-800 border border-slate-700 flex items-center justify-center text-amber-400 flex-shrink-0" id="icon_preview_box">
                            <i class="fa-solid fa-utensils text-base" id="icon_preview_el"></i>
                        </div>
                    ...
                    <p class="text-xs text-slate-500 mt-1.5">
                        Buscá íconos en
                        <a href="https://fontawesome.com/icons" target="_blank" class="text-amber-400 underline">fontawesome.com/icons</a>.
                        Ej: <code class="bg-slate-800 px-1 rounded">fa-solid fa-bread-slice</code>
                    </p>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Texto corto que aparece bajo el título de la sección. Opcional.</p>
                </div>
                ...
                <div>
                    ...
                    <select name="note_type"
                        ...
                        <option value="preorder">🔔 Pedido previo (naranja)</option>
                        <option value="time">🕐 Tiempo / Anticipación (naranja claro)</option>
                    </select>
                </div>
...
(function () {
    ...
    if (iconInput) {
        iconInput.addEventListener('input', function () {
            updatePreview(this.value.trim() + ' text-base');
        });
    }

    quickBtns.forEach(function (btn) {
        btn.addEventListener('click', function () {
            var cls = this.dataset.icon;
            iconInput.value = cls;
            updatePreview(cls + ' text-base');
        });
    });
})();
</script>
