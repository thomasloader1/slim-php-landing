        ...
        <div class="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden shadow-sm">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    @if($item->image_url)
                        <div class="mb-3 flex items-start gap-4">
                            <img src="{{ $item->image_url }}" alt="{{ $item->title }}"
                                 class="w-32 h-24 object-cover rounded-xl border border-slate-700" id="current_img">
                    ...
                    <p class="text-xs text-slate-500 mt-1">Subí una nueva imagen para reemplazar la actual. Opcional.</p>
